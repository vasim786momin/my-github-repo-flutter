...
//
//     final repoDetails = repoDetailsFromJson(jsonString);

import 'dart:convert';

RepoDetails repoDetailsFromJson(String str) => RepoDetails.fromJson(json.decode(str));

String repoDetailsToJson(RepoDetails data) => json.encode(data.toJson());
